...
`;
    ...
    if (content.includes('id="sidebar"')) {
        ...
        // 1. CLEANUP: Remove all previously injected headers and problematic links to reset state
        ...
        // 2. INJECT: Re-apply headers and links in correct order
        // Menu Utama
        ...
        // 3. POST-PROCESS: Cleanup whitespace artifacts
