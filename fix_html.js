...
for (const file of htmlFiles) {
    ...
    if (file === 'batch-upload.html' && !content.includes('js/batch-upload-v8.js')) {
    ...
    <script src="js/batch-upload-v8.js${vStamp}"></script>
    <script>
...
`;
    ...
    // General replacement for all files to use v8
    content = content.replace(/js\/batch-upload(?:\.js|-v[0-9]+\.js)(?:\?v=[0-9]+)?/g, `js/batch-upload-v8.js${vStamp}`);
